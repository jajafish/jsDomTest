...
jsdom.env({
    ...
    scripts: [
        ...
        var numOfImgs = window.$('img').length;

        for (var i = 0; i < numOfImgs; i ++) {
            var imgEl = window.$('img');
